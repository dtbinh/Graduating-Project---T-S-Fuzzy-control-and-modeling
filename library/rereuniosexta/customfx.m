...
line([1,9],[1,9],'marker','o','linestyle','none','markerfacecolor','r')

x0 = [15; 10];
[t,y]=ode45(@fx,[0 20],x0); 
x02 = [16; 10];
[t2,y2]=ode45(@fx,[0 20],x02); 
...
%Linearization
syms x1 x2
A = jacobian([x2-x1; 16-(x1-5).^2],[x1 x2]);
x1=9; x2=9; %linearization point
%Ax = eval(subs(A));
Ax = subs(A);
eig(Ax)
